...
export class RecipientTools {
    ...
    async createRecipient(params) {
        try {
            ...
            const recipient = await this.omiseClient.post('/recipients', recipientParams);
            return {
                success: true,
                data: recipient,
            ...
            this.logger.error('Failed to create recipient via MCP tool', error, params);
            return {
                success: false,
    ...
    async retrieveRecipient(params) {
        try {
            ...
            const recipient = await this.omiseClient.get(`/recipients/${params.recipient_id}`);
            return {
                success: true,
                data: recipient,
            ...
            this.logger.error('Failed to retrieve recipient via MCP tool', error, { recipientId: params.recipient_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listRecipients(params) {
        try {
            ...
            const recipients = await this.omiseClient.get('/recipients', queryParams);
            return {
                success: true,
                data: recipients,
            ...
            this.logger.error('Failed to list recipients via MCP tool', error, params);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async updateRecipient(params) {
        try {
            ...
            if (params.tax_id !== undefined)
                updateData.tax_id = params.tax_id;
            if (params.bank_account !== undefined)
                updateData.bank_account = params.bank_account;
            ...
            const recipient = await this.omiseClient.put(`/recipients/${params.recipient_id}`, updateData);
            return {
                success: true,
                data: recipient,
            ...
            this.logger.error('Failed to update recipient via MCP tool', error, { recipientId: params.recipient_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async destroyRecipient(params) {
        try {
            ...
            const recipient = await this.omiseClient.delete(`/recipients/${params.recipient_id}`);
            return {
                success: true,
                data: recipient,
            ...
            this.logger.error('Failed to destroy recipient via MCP tool', error, { recipientId: params.recipient_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async verifyRecipient(params) {
        try {
            ...
            const recipient = await this.omiseClient.post(`/recipients/${params.recipient_id}/verify`, verificationData);
            return {
                success: true,
                data: recipient,
            ...
            this.logger.error('Failed to verify recipient via MCP tool', error, { recipientId: params.recipient_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
...
//# sourceMappingURL=recipient-tools.js.map