...
export class ChainTools {
    ...
    validateRollbackSteps(rollbackSteps, originalSteps) {
    ...
    async executeChainStep(step, context) {
        try {
            ...
            this.logger.error(`Chain step ${step.step_id} failed`, error);
    ...
    async createChain(params) {
        try {
            ...
            const chain = await this.omiseClient.post('/chains', chainParams);
            return {
                success: true,
                data: chain,
            ...
            this.logger.error('Failed to create payment chain via MCP tool', error, params);
            return {
                success: false,
    ...
    async retrieveChain(params) {
        try {
            ...
            const chain = await this.omiseClient.get(`/chains/${params.chain_id}`);
            return {
                success: true,
                data: chain,
            ...
            this.logger.error('Failed to retrieve payment chain via MCP tool', error, { chainId: params.chain_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listChains(params) {
        try {
            ...
            const chains = await this.omiseClient.get('/chains', queryParams);
            return {
                success: true,
                data: chains,
            ...
            this.logger.error('Failed to list payment chains via MCP tool', error, params);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listChainRevisions(params) {
        try {
            ...
            const revisions = await this.omiseClient.get(`/chains/${params.chain_id}/revisions`, queryParams);
            return {
                success: true,
                data: revisions,
            ...
            this.logger.error('Failed to list chain revisions via MCP tool', error, { chainId: params.chain_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
...
//# sourceMappingURL=chain-tools.js.map