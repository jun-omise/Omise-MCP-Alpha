...
export class ScheduleTools {
    ...
    validateScheduleId(scheduleId) {
        // Omise schedule ID format: schd_xxxxxxxxxxxxxxxx
        return /^schd_[a-zA-Z0-9]{16}$/.test(scheduleId);
    }
    validateCustomerId(customerId) {
        // Omise customer ID format: cust_xxxxxxxxxxxxxxxx
    ...
    validateSchedulePeriod(period, every) {
    ...
    async createSchedule(params) {
        try {
            ...
            const schedule = await this.omiseClient.post('/schedules', scheduleParams);
            return {
                success: true,
                data: schedule,
            ...
            this.logger.error('Failed to create schedule via MCP tool', error, params);
            return {
                success: false,
    ...
    async retrieveSchedule(params) {
        try {
            ...
            const schedule = await this.omiseClient.get(`/schedules/${params.schedule_id}`);
            return {
                success: true,
                data: schedule,
            ...
            this.logger.error('Failed to retrieve schedule via MCP tool', error, { scheduleId: params.schedule_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listSchedules(params) {
        try {
            ...
            const schedules = await this.omiseClient.get('/schedules', queryParams);
            return {
                success: true,
                data: schedules,
            ...
            this.logger.error('Failed to list schedules via MCP tool', error, params);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async destroySchedule(params) {
        try {
            ...
            const schedule = await this.omiseClient.delete(`/schedules/${params.schedule_id}`);
            return {
                success: true,
                data: schedule,
            ...
            this.logger.error('Failed to destroy schedule via MCP tool', error, { scheduleId: params.schedule_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listScheduleOccurrences(params) {
        try {
            ...
            const occurrences = await this.omiseClient.get(`/schedules/${params.schedule_id}/occurrences`, queryParams);
            return {
                success: true,
                data: occurrences,
            ...
            this.logger.error('Failed to list schedule occurrences via MCP tool', error, { scheduleId: params.schedule_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
