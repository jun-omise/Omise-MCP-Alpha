...
export class PaymentTools {
    ...
    async createCharge(params) {
        try {
            ...
            this.logger.error('Failed to create charge via MCP tool', error, params);
            return {
                success: false,
    ...
    async retrieveCharge(params) {
        try {
            ...
            this.logger.error('Failed to retrieve charge via MCP tool', error, { chargeId: params.charge_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async listCharges(params) {
        try {
            ...
            this.logger.error('Failed to list charges via MCP tool', error, params);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async updateCharge(params) {
        try {
            ...
            const charge = await this.omiseClient.put(`/charges/${params.charge_id}`, updateData);
            return {
                success: true,
                data: charge,
            ...
            this.logger.error('Failed to update charge via MCP tool', error, { chargeId: params.charge_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async captureCharge(params) {
        try {
            ...
            const charge = await this.omiseClient.post(`/charges/${params.charge_id}/capture`, captureData);
            return {
                success: true,
                data: charge,
            ...
            this.logger.error('Failed to capture charge via MCP tool', error, { chargeId: params.charge_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async reverseCharge(params) {
        try {
            ...
            const charge = await this.omiseClient.post(`/charges/${params.charge_id}/reverse`, reverseData);
            return {
                success: true,
                data: charge,
            ...
            this.logger.error('Failed to reverse charge via MCP tool', error, { chargeId: params.charge_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
    ...
    async expireCharge(params) {
        try {
            ...
            const charge = await this.omiseClient.post(`/charges/${params.charge_id}/expire`, {});
            return {
                success: true,
                data: charge,
            ...
            this.logger.error('Failed to expire charge via MCP tool', error, { chargeId: params.charge_id });
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error occurred'
            };
...
//# sourceMappingURL=payment-tools.js.map